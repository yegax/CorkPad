...
$(document).ready(function(){
    ...
    $("#bright-theme").click(function() {
        ...
        $("#lock-videos-icon, #lock-custom-icon, #material-dropdown-theme-a, #solid-dropdown-theme-a, #video-dropdown-theme-a, #custom-dropdown-theme-a").removeClass("bg-gray-main-dark-text");
        $("#lock-videos-icon, #lock-custom-icon, #material-dropdown-theme-a, #solid-dropdown-theme-a, #video-dropdown-theme-a, #custom-dropdown-theme-a").addClass("bg-gray-main-text");
