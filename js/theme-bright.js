...
$(document).ready(function(){
    ...
    $("#bright-theme").click(function() {
        ...
        $("#material-dropdown-theme-a, #solid-dropdown-theme-a, #video-dropdown-theme-a, #custom-dropdown-theme-a").removeClass("bg-gray-main-dark-text");
        $("#material-dropdown-theme-a, #solid-dropdown-theme-a, #video-dropdown-theme-a, #custom-dropdown-theme-a").addClass("bg-gray-main-text");
